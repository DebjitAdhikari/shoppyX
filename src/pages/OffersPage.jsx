              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="sm:flex sm:block hidden items-center text-indigo-600 sm:font-medium group-hover:translate-x-2 transition-transform duration-300">
                      Shop Now
